...
<html>
    ...
    <div class="box">
		<form action="${pageContext.servletContext.contextPath}/signIn" method="post">
				...
				<div class="login">
                	<div class="loginText">
						...
						<input type ="Text" name="email" size="12" value="${email}" placeholder="Email">
						</br>
						<input type = "Password" name="password" size="12" value="${password}" placeholder="Password">
                        </br>
						</br>
				...
				<a  href = "http://localhost:8081/CapstoneActivityTracker/passForgot"><b>Forgot Password?</b></a>
                <input type="submit" name="signIn" value="Log In" />
                </br>
                <a  href = "http://localhost:8081/CapstoneActivityTracker/signUp"><b>Create Account</b></a>
				</div>
        ...
        <div class="empty"></div>		
            ...
            <img id="person" src=https://www.ycp.edu/media/york-website/style-assets-2016/images/YCPStudentFooter.png
/>
	</body>
</html>
